...
LSM:Register(MediaType_FONT, "Times",				        [[Interface\Addons\SharedMedia\fonts\times\times.ttf]])
LSM:Register(MediaType_FONT, "Calibri",				        [[Interface\Addons\SharedMedia\fonts\calibri_font\calibri_regular.ttf]])
