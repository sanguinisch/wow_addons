...
function private.PerItemOnClick(button)
	...
	buyoutInput:SetFocused(false)
		:SetValue(Money.ToString(row:GetField("buyout")))
		:Draw()
	bidInput:SetFocused(false)
		:SetValue(Money.ToString(row:GetField("bid")))
		:Draw()
end
...
function private.PerStackOnClick(button)
	...
	local buyoutInput = button:GetElement("__parent.__parent.buyout.input")
	buyoutInput:SetFocused(false)
		:SetValue(Money.ToString(row:GetField("buyout") * stackSize))
		:Draw()
	bidInput:SetFocused(false)
		:SetValue(Money.ToString(row:GetField("bid") * stackSize))
		:Draw()
end
